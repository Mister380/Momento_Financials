...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const FALLBACK_IMAGES = {
        ...
        'cashFlowChart': 'images/charts/cash-flow-chart.png',
        'costScalingChart': 'images/charts/cost-scaling-chart.png',
            ...
            const clvCacChart = new Chart(clvCacCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [17.30, 28.35, 38.50, 52.50, 67.40],
                        backgroundColor: colors.primary,
                        borderColor: colors.primary,
                        borderWidth: 1
                    }, {
                        label: 'Customer Acquisition Cost (CAC)',
                        data: [4.80, 4.20, 3.90, 3.60, 3.30],
                        backgroundColor: colors.secondary,
                        borderColor: colors.secondary,
                        borderWidth: 1
                    }]
            ...
            const mrrChart = new Chart(mrrCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [3064, 14285, 40396, 81750, 141646],
                        fill: true,
                        backgroundColor: colors.primaryLight,
                        borderColor: colors.primary,
                        tension: 0.3,
